...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    public function activate(Composer $composer, IOInterface $io)
    {
        ...
        $this->ensureFile('futuretek/console.php');
        $this->ensureFile('futuretek/components.php');
        $this->ensureFile('futuretek/web.php');
        $this->ensureFile('futuretek/modules.php');
        $this->ensureFile('futuretek/modules.dev.php');
        $this->ensureFile('futuretek/bootstrap.php');
